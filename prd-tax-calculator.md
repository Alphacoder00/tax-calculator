# TaxWise — Complete Product Specification
...
│   ├── Logo (TaxWise + "India Tax Calculator" subtitle)
...
1. **Sticky nav** (always shown):
   ...
   - **Logo** (always visible, clickable → `reset()`):
     ...
     - Brand text: "TaxWise" (`text-sm font-bold text-gray-900 tracking-tight leading-none`)
...
- Brand: `text-sm font-bold text-gray-900 tracking-tight` — "TaxWise"
