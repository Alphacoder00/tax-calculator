  ...
  return (
    <div className="glass-card p-6 sm:p-10 mb-8">
      ...
      <div className="space-y-4 mb-10">
        <label className="relative flex items-center p-5 cursor-pointer rounded-2xl border-2 transition-all border-primary bg-primary/5 shadow-sm">
          <input 
            type="radio" 
            name="fy" 
            value="2025-26" 
          ...
          <div className="ml-auto bg-primary text-white text-[10px] font-bold px-3 py-1 rounded-full uppercase tracking-widest shadow-sm">
            Current
          </div>
        </label>
      </div>
